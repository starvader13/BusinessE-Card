...
const Testimonials = ({name, message, profession }) => {
    return (
        <div className={"flex flex-col justify-start-center border-2 rounded-xl bg-gray-800 p-4 gap-2 text-white animate-bounceOnce"}>
