...
const Footer = () => {
    ...
    return (
        <section className={"flex justify-evenly border-none rounded-lg bg-gray-100 md:mx-9 md:py-8 font-mono tracking-tight"}>
            ...
            <div className={"flex flex-col justify-start bottom-0 "}>
                ...
                <ul className={"text-sm lg:text-md font-medium"}>
                    ...
                    <a href="https://github.com/starvader13/BusinessE-Card" target={"_blank"} rel={"noreferrer noopener"}><li className={"footer-text"}>
                        <div>Contribute</div>
                        <FaGithubSquare />
                    </li></a>
                    <a href="" target={"_blank"} rel={"noreferrer noopener"}><li className={"footer-text"}>
                        <div>Docs</div>
                        <IoDocumentText />
                    </li></a>
                </ul>
